#include "erl_geometry_rviz_plugin/ros2/mesh_display.hpp"
...
namespace erl::geometry::rviz_plugin {
    ...
    MeshDisplay::MeshDisplay()
        ...
        m_ply_file_property_ = new rviz_common::properties::StringProperty(
            "PLY File",
            "",
        ...
        m_use_normals_property_ = new rviz_common::properties::BoolProperty(
            "Compute Normals",
            true,
    ...
    void
    MeshDisplay::processMessage(erl_geometry_msgs::msg::MeshMsg::ConstSharedPtr msg) {
        std::lock_guard<std::mutex> lock(m_mutex_);
...
PLUGINLIB_EXPORT_CLASS(erl::geometry::rviz_plugin::MeshDisplay, rviz_common::Display)
