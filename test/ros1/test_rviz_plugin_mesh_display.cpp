...
class Node {
    ...
    ros::Publisher m_pub_3d_;
    ros::Publisher m_pub_2d_;
    ros::Timer m_timer_;
    erl_geometry_msgs::MeshMsg m_msg_3d_;
    erl_geometry_msgs::MeshMsg m_msg_2d_;
...
public:
    Node(ros::NodeHandle &nh)
        ...
        m_pub_3d_ = m_nh_.advertise<erl_geometry_msgs::MeshMsg>("mesh", 1, true);
        m_pub_2d_ = m_nh_.advertise<erl_geometry_msgs::MeshMsg>("mesh_2d", 1, true);
        ...
        // publish both
        m_msg_3d_.header.stamp = ros::Time::now();
        m_pub_3d_.publish(m_msg_3d_);
        m_msg_2d_.header.stamp = ros::Time::now();
